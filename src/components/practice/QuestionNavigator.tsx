          ...
          return (
            <button
              ...
              className={cn(
                ...
                isAnswered && "border-green-500 bg-green-500/20 text-green-700 dark:text-green-300",
                isFlagged && !isAnswered && "border-yellow-500 bg-yellow-500/20 text-yellow-700 dark:text-yellow-300",
                !isAnswered && !isFlagged && "border-muted bg-muted/50 text-muted-foreground",
